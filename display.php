...
<body class="loggedin" bgcolor="EEFDEF">
    <nav class="navtop">
        <div>
            ...
            <h1> Filter Data</h1>
            <a href="download.php"><i class="fas fa-file-csv"></i>Export Excel</a>
    ...
    <div>
        ...
        $result1701 = mysqli_query($con, "SELECT SOCKETNAME, WORKWEEK, SITETOTAL, REPLACEFREQUENCY FROM ibpmcosting WHERE SOCKETNAME='" . $serialno . "' AND REPLACEFREQUENCY='0' ORDER BY SITETOTAL_ACCUMULATEDCOUNT");
